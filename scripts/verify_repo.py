...
PR355_EVIDENCE_NATIVE_MECHANISM_OS_COMMAND: Final[list[str]] = [
    sys.executable,
    "scripts/verify_pr355.py",
    "--json",
]

PR356_AUTONOMOUS_MARKET_SCIENCE_COMMAND: Final[list[str]] = [
    sys.executable,
    "scripts/verify_pr356.py",
    "--json",
]

PR356_CORRECTIVE_COMPLETION_COMMAND: Final[list[str]] = [
    sys.executable,
    "scripts/verify_pr356_completion.py",
]

PR357_ADAPTIVE_STRATEGY_INTELLIGENCE_COMMAND: Final[list[str]] = [
    sys.executable,
