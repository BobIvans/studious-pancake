...
PACKAGES = {
    "EVO-01": {
        ...
        "names": [
            ...
            "detect_pre_post_activation_basis",
            "bound_governance_execution_uncertainty",
            "build_governance_transition_candidate",
            "qualify_governance_transition",
        ],
    },
    "EVO-02": {
        "module": "incentive_epoch",
        "start": 1025,
        "names": [
            "ingest_epoch_emission_schedule",
            "compute_gauge_reward_surface",
            "estimate_incentive_vote_break_even",
            "forecast_fee_distributor_claim",
            "compute_buyback_pressure_band",
    ...
    "EVO-06": {
        "module": "intent_rescue",
        "start": 1057,
        "names": [
            "normalize_intent_auction",
