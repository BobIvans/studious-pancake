#!/usr/bin/env python3
"""Verify the MPR-NEXT-01 product truth and release hygiene gate."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("MPR-NEXT-01 product truth / release hygiene gate passed.")
    else:
        print("MPR-NEXT-01 gate failed:", file=sys.stderr)
