...
2. all required vertical stages were observed: discovery, capital, planner,
   compiler, simulation, reconciliation, lifecycle;
...
9. the evidence bundle is signed or points to a signed evidence artifact.
