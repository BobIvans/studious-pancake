"""Supported PR-023 launcher and runtime truth CLI."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "status":
            ...
            return 0 if payload["capability_contract_valid"] else EXIT_CONFIGURATION_ERROR
