...
CONTRACT_SCHEMAS = {
    ...
    "InvariantLawCandidate": [
        "law_id",
        "expression_or_constraint",
        "variables",
        "units",
        "economic_semantics",
        "market_scope",
    ...
    "RelationAtlasScorecard": [
        "benchmark_id",
        "discovery_fdr",
        "oos_predictive_rate",
        "multi_regime_stability",
    ...
    "RelationTransferCard": [
        "motif_id",
        "source_markets",
        "target_market",
        "semantic_mapping",
        "target_local_baseline",
        "transfer_model",
    ...
    "TailRelationCard": [
        "relation_id",
        "tail_definition",
        "copula_or_tail_model",
        "upper_tail",
        "lower_tail",
        "conditional_tail_metrics",
        "stress_periods",
        "heldout_metrics",
        "uncertainty",
    ],
    ...
    "ConfidentialServiceCard": [
        "service_id",
        "confidential_input_class",
        "reveal_policy",
        "trusted_components",
        "attestation_or_protocol_refs",
        "leakage_metric",
        "latency_overhead",
        "consumer_quality",
    ...
    "MarketScienceExchangeScorecard": [
        "benchmark_id",
        "service_ids",
        "consumer_tasks",
        "service_quality",
    ...
    "ServiceEconomicsCard": [
        ...
        "price_trials",
        "subsidy",
        "gross_margin_research",
        "break_even_volume",
    ],
    "ServiceFulfillmentReceipt": [
        "request_id",
        "service_id",
        "provider_id",
        "artifact_hash",
    ...
    "SolverMarketEpisode": [
        ...
        "fill_attempts",
        "user_output",
        "gas_and_inventory_cost",
        "fade_or_failure",
        "winner",
        "evidence_refs",
    ],
    "SponsorshipEconomicsCard": [
        "provider",
        "fee_asset",
        "payment_asset",
        "network_fee",
        "account_creation_cost",
        "conversion_cost",
        "failure_cost",
        "abuse_loss",
        "reserve_requirement",
    ...
    "VerifiableSimulationOffer": [
        "offer_id",
        "candidate_hash",
        "state_root_or_snapshot",
        "transaction_or_plan_hash",
        "simulator_version",
        "balance_delta_commitment",
        "fee_commitment",
        "proof_or_replay_method",
        "privacy_policy",
        "verification_cost",
    ],
}
