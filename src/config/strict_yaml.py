...
# Dates/timestamps are not part of the configuration scalar contract. Keep them as
# strings so typed schemas must opt in explicitly instead of accepting locale-like
# implicit conversion.
